...
public class BlogController {
    ...
    private void initializeRoutes() throws IOException {
        ...
        Spark.get(new FreemarkerBasedRoute("/", "blog_template.ftl") {
            @Override
        ...
        Spark.post(new FreemarkerBasedRoute("/signup", "signup.ftl") {
            @Override
        ...
        Spark.get(new FreemarkerBasedRoute("/signup", "signup.ftl") {
            @Override
        ...
        Spark.get(new FreemarkerBasedRoute("/welcome", "welcome.ftl") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        Spark.get(new FreemarkerBasedRoute("/login", "login.ftl") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
        ...
        Spark.post(new FreemarkerBasedRoute("/login", "login.ftl") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        Spark.get(new FreemarkerBasedRoute("/logout", "signup.ftl") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        Spark.get(new FreemarkerBasedRoute("/internal_error", "error_template.ftl") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
